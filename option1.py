...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='mnist2', help='folder | cifar10 | mnist ')
        ...
        self.parser.add_argument('--nz', type=int, default=256, help='size of the latent z vector')
        self.parser.add_argument('--ngf', type=int, default=64)
        self.parser.add_argument('--ndf', type=int, default=64)
        self.parser.add_argument('--nvf', type=int, default=12)
        ...
        #
        self.parser.add_argument('--name', type=str, default='ocgan/mnist-0', help='name of the experiment')
        self.parser.add_argument('--model', type=str, default='ocgan', help='chooses which model to use. ganomaly')
        ...
        self.parser.add_argument('--proportion', type=float, default=1, help='Proportion of anomalies in test set.')
        ...
        self.parser.add_argument('--save_test_images', action='store_true', default=False,help='Save test images for demo.')
        self.parser.add_argument('--load_weights', action='store_true',default=False, help='Load the pretrained weights')
        #output/ocgan/fmnist-1/train/weights
        ...
        self.parser.add_argument('--niter', type=int, default=30, help='number of epochs to train for')
        ...
        #
        self.parser.add_argument('--mine', action='store_true', default=True, help='use mine stay')
        self.isTrain = True
        self.opt = None
