...
from lib.mnist import FashionMNIST
...
def load_data(opt):
    ...
    if opt.dataset in ['cifar10']:
        ...
        dataset = {}
        dataset['train'] = FashionMNIST(root='./data/fmnist', train=True, download=True, transform=transform)
        dataset['test'] = FashionMNIST(root='./data/fmnist', train=False, download=True, transform=transform)
